...
-- select * from max_leadgen_sponsor_ad where stats_date between (curdate() - interval 5 day) and (curdate()) and (url_lead_status like '%Auto%' or url_lead_status like '%auto%') order by created_on desc;
