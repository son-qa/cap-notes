...
'FSPU-Clicksquad-2step-reg', 'FSPU-Dynamic-Flow-Templatization')
...
'TAS-Groceries-Hook', 'TAS-Gaming-Flow') 
order by experiment_type desc, updated_on desc ;

-- https://freesamplesprousa.com/?test=1&var=405&cid=21eo8&exp=FSPU-Dynamic-Flow-Templatization
-- https://theamericansweepstakes.com/?test=1&var=405&cid=n9gb2&exp=TAS-Gaming-Flow
