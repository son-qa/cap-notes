...
, 'FSPU-TCPA-Opt-Out-Feature', 'FSPU-Dynamic-Flow-SPII-TCPA-Opt-Out-Control', 'FSPU-LP-V2', 'FSPU-DBbased-NewUserFlow', 'FSPU-Generic-Flow-Multipage-PII')
...
'TAS-LP-Custom-Flow-V3', 'scratch-to-win-lander', 'TAS-LP-V2') 
order by experiment_type desc, updated_on desc ;

-- https://freesamplesprousa.com/?test=1&var=405&cid=21eo8&exp=FSPU-Generic-Flow-Multipage-PII
-- https://theamericansweepstakes.com/?test=1&var=405&cid=n9gb2&exp=TAS-LP-V2
